...
public static class ComponentTransferModule
{
    ...
    public static void MapComponentTransferModuleEndpoints(this WebApplication app)
    {
        ...
        app.MapPost("/transfer/component/save/legacy", ComponentTransferModuleApis.SaveTransferRequestAsync)
       ...
       .WithOpenApi(operation =>
        ...
        app.MapPost("/transfer/component/approve/legacy", ComponentTransferModuleApis.ApproveTransferAsync)
        ...
        app.MapPost("/transfer/component/cancel/legacy", ComponentTransferModuleApis.CancelTransferAsync)
        .Produces<WorkflowCreateDto>(StatusCodes.Status200OK)
        .Produces(StatusCodes.Status204NoContent)
        .WithOpenApi(operation =>
        {
