...
public static class SeedExtension
{
    public static void SeedUserLifecycle(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Transition>().HasData(new { FromStateName = "user-start", ToStateName = "user-active", Name = "user-register", FlowName = "user-register", CreatedAt = DateTime.SpecifyKind(DateTime.UtcNow, DateTimeKind.Utc), CreatedBy = Guid.Empty, ModifiedAt = DateTime.SpecifyKind(DateTime.UtcNow, DateTimeKind.Utc), ModifiedBy = Guid.Empty });
