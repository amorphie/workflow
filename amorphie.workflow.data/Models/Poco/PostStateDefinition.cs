...
public record PostTransitionDefinitionRequest(string name, MultilanguageText title, string toState, string? form, string fromState, string? message, string? gateway);

public record PostFSMTransitionDefinition(string name, MultilanguageText title, string toState, string? form, string fromState) : PostTransitionDefinitionRequest(name, title, toState, form,fromState,null,null);
public record PostZeebeTransitionDefinition(string name, MultilanguageText title, string toState, string? form, string fromState, string message, string gateway) : PostTransitionDefinitionRequest(name, title, toState, form,fromState,message,gateway);
