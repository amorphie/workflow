...
namespace amorphie.workflow.data.Migrations
{
    ...
    [Migration("20240807145626_MigrationHTClaim")]
    partial class MigrationHTClaim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("State", b =>
                {
                    ...
                    b.Property<string[]>("AllowedSuffix")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Workflow", b =>
                {
                    ...
                    b.Property<bool?>("IsAllowOneActiveInstance")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("amorphie.workflow.core.Models.HumanTask", b =>
                {
                    ...
                    b.Property<bool?>("AutoTransaction")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("ClaimBy")
                        .HasColumnType("text");

                    b.Property<DateTime?>("ClaimDueDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("HumanTasks");
                });

            modelBuilder.Entity("amorphie.workflow.core.Models.Instance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("XDeviceId")
                        .HasColumnType("text");

                    b.Property<string>("XTokenId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("amorphie.workflow.core.Models.InstanceEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("amorphie.workflow.core.Models.InstanceTransition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("amorphie.workflow.core.Models.JsonSchema", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("amorphie.workflow.core.Models.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("amorphie.workflow.core.Models.InstanceEvent", b =>
                {
                    b.HasOne("amorphie.workflow.core.Models.InstanceTransition", "InstanceTransition")
                        .WithMany()
            ...
            modelBuilder.Entity("amorphie.workflow.core.Models.InstanceTransition", b =>
                {
                    ...
                    b.HasOne("amorphie.workflow.core.Models.Instance", "Instance")
                        .WithMany()
            ...
            modelBuilder.Entity("amorphie.workflow.core.Models.Note", b =>
                {
                    b.HasOne("amorphie.workflow.core.Models.Instance", null)
                        .WithMany("Notes")
                        .HasForeignKey("InstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
