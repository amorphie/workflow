...
public class WorkflowService : IWorkflowService
{
    ...
    public WorkflowService(WorkflowDBContext dbContext)
    {
        _dbContext = dbContext;
        _dbSet = dbContext.Set<Workflow>();
    }

    public async Task<Response> SaveAsync(WorkflowCreateDtoLegacy data)
    {
    ...
    public void Insert(WorkflowCreateDtoLegacy data)
    {
    ...
    public void Update(WorkflowCreateDtoLegacy data, Workflow existingRecord)
    {
        //Why is this bussines for
        bool recordIdNull = false;
        if (data.RecordId == Guid.Empty)
    ...
    private List<WorkflowEntity> InsertEntityList(WorkflowCreateDtoLegacy data)
    {
