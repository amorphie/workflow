...
{
    Task<Response> SaveBulkAsync(List<StateCreateDto> states, string workflowName,CancellationToken token);
    Task<Response> SaveAsync(StateCreateDto data, string workflowName,CancellationToken token);
